...
var _webpack3 = require('../scripts/webpack.server');
...
compiler.plugin('emit', function (compilation, callback) {
    ...
    Object.keys(assets).forEach(function (key) {
        if (key.match(/\.html$/)) {
            file = _path2.default.resolve(dir, _env2.default.getParam('htmlFilePath'));
...
_app2.default.use((0, _koaViews2.default)(_path2.default.resolve(dir, _env2.default.getParam('viewsDir')), { map: { html: 'ejs' } })); //处理模板
