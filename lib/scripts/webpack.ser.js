...
var externals = serverModule ?
    ...
    clientPlugins = [new webpack.optimize.OccurrenceOrderPlugin(), new webpack.optimize.CommonsChunkPlugin({
        ...
        allChunks: true
    }), new ProgressBarWebpackPlugin(), new webpack.NormalModuleReplacementPlugin(/\/iconv-loader$/, 'node-noop'), new CopyWebpackPlugin(env.getParam('staticResourceCopy').map(function (i) {
        return {from: i};
    }))],
