...
var clientPlugins = [new webpack.optimize.OccurrenceOrderPlugin(), new webpack.optimize.CommonsChunkPlugin({
    names: ['vendor', 'manifest'],
    filename: env.getParam('chunkFileName'), //`[name].[chunkhash:${hashLen}].js`,
    children: true
}), new webpack.optimize.AggressiveMergingPlugin(), new webpack.optimize.LimitChunkCountPlugin({
